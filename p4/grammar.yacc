...
paramList : paramList COMMA param 
		{ $$ = new ParamListNode($1, $3, $2.line, $2.column); }
	  | param
...
stmt	: target ASSIGN expression SEMICOLON
	...
	| RETURN SEMICOLON
		{ $$ = new ReturnNode((ExpressionNode *)NULLnode, 
							 $1.line, $1.column); }
...
argList : argList COMMA expression
	...
	| expression
		{ $$ = new ArgListNode((ArgListNode *)NULLnode, 
					$1, $1->line, $1->column); }
	;
...
ORlist: ORlist OR ANDexpression
		{ $$ = new OrNode($1, $3, $2.line, $2.column); }
      | ANDexpression
		{ $$ = $1; }
      ;
...
ANDlist: ANDlist AND term 
		{ $$ = new AndNode($1, $3, $2.line, $2.column); }
       | term
		{ $$ = $1; };
...
primary	: primary TIMES unit 
		{ $$ = new ArithOpNode( TIMES, $1, $3, $2.line, $2.column); }
	| primary SLASH unit 
		{ $$ = new ArithOpNode( SLASH, $1, $3, $2.line, $2.column); }
	| unit  { $$ = $1; }
	;
...
unit : nameVar  { $$ = $1; }
     ...
     | identifier LPAREN RPAREN 
		{ $$= new FnCallNode($1, (ArgListNode *)NULLnode, 
				     $2.line, $2.column); }
     | identifier LPAREN argList RPAREN 
		{ $$= new FnCallNode($1, $3, $2.line, $2.column); }
...
arrayVar: identifier LBRACKET expression RBRACKET 
		{ $$ = new ArrayVarNode( $1, $3, $1->line, $1->column); };

intLiteral : INTLITERAL
             { $$ = new IntLiteralNode($1.intVal, $1.line,$1.column); };

stringLiteral : STRINGLITERAL 
	     { $$ = new StringLiteralNode($1.stringVal, $1.line, $1.column);};
